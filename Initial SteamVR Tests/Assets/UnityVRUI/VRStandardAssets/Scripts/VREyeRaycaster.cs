...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        // added by Jeff
        public bool isHit; // we need to do this to know whether or not the hit was on something we want to track (the right layer)
        public int hitLayer; // the hitLayer will be used to distinguish between interactive and teleport-friendly areas
